...
public class BulkExtractorScanListReader {
  ...
  public static class Scanner {
	...
	/**
	 * @return the defaultUseScanner
	 */
	public boolean isDefaultUseScanner() {
		return defaultUseScanner;
	}
	/**
	 * @return the useScanner
	 */
	public boolean isUseScanner() {
		return useScanner;
	}
	/**
	 * @param useScanner the useScanner to set
	 */

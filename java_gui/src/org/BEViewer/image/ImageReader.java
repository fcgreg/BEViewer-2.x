...
import org.BEViewer.ForensicPath;
import org.BEViewer.ThreadReaderModel;
import org.BEViewer.WError;
import org.BEViewer.WLog;
...
public class ImageReader {
  ...
  public static class ImageReaderResponse {
    ...
    public ImageReaderResponse(final byte[] bytes, long totalSizeAtPath) {
      this.bytes = bytes;

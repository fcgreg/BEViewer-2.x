...
import org.BEViewer.image.BulkExtractorScanListReader;
import org.BEViewer.image.BulkExtractorScanListReader.Scanner;
...
public class ScanSettings {
  ...
  public ScanSettings(ScanSettings scanSettings) {
    ...
    for (Iterator<BulkExtractorScanListReader.Scanner> it = scanSettings.scanners.iterator(); it.hasNext();) {
      ...
      scanners.add(new BulkExtractorScanListReader.Scanner(scanner.getName(), scanner.isDefaultUseScanner(), scanner.isUseScanner()));
    }
  }
